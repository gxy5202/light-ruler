 ...
 */
export const createHTMLStringDom = (styleObject: RulerOuterStyle, type: string): string => {
    let rulerHTML: string;

    const size = styleObject.size > styleObject.maxSize ? styleObject.maxSize : styleObject.size;
    const width = styleObject.width > styleObject.maxWidth ? styleObject.maxWidth : styleObject.width;
    const height = styleObject.height > styleObject.maxHeight ? styleObject.maxHeight : styleObject.height;

    const canvasRulerWrapperStart: string = `<div id="canvas-ruler-wrapper${styleObject.rulerId}" 
...
/**
     ...
     */
export const createHTMLDom = (type: string, attr: any, text?: string): HTMLElement => {
...
export const appendDom = (fatherDom: DomElement = null, ChildDom: DomElement = null): Promise<DomElement> => new Promise((resolve, reject) => {
...
export const createFragmentDom = (styleObject: RulerOuterStyle): void => {
    ...
    const wrapperElement: HTMLElement = document.getElementById(styleObject.wrapperId);
